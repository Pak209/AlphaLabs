...
class AlphaLabService:
    ...
    def rejection_waterfall(self, limit: int = 5000) -> dict[str, Any]:
        ...
        Delegates to alpha_lab.waterfall.build_rejection_waterfall — extracted
        in Phase 2 PR1 (docs/PHASE2_PLAN.md); output contract pinned by
        tests/test_waterfall_golden.py. Never mutates anything.
        """
        return build_rejection_waterfall(self.db_path, limit=limit)
    ...
    def _btc_signal_from_market(self, btc: dict[str, Any]) -> dict[str, Any]:
        ...
        # construction lives in crypto_signals (Phase 2 PR5, value-pinned by
        # tests/test_crypto_signals_golden.py).
        return btc_signal_from_market(btc)
