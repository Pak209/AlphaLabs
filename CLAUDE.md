# AlphaLabs — Claude Project Instructions
...
memory**, shared by Claude, Codex, Lex, and human operators. A new contributor must be
...
`.agents/skills/alphalabs-handoff-update/`. Claude follows the **same** file contract.
...
- Every entry identifies the actor: exactly one of `Claude`, `Codex`, `Lex`, `Human`.
